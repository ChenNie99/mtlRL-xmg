...
class Reinforce(object):
    ...
    def episode(self, phaseTrain=True, epoch=0):
        ...
        gate_num, latency, energy, row_usage, energy_latency_product = self._env.get_end2end_states()
        # os.system('ls')
        # command_temp = "./converter -d --xor3 " + str(self.brief_name) +"_syn_out_opt_1.v"
        # os.system(command_temp)
        # command_temp2 = "python3 map_priority.py " + self.brief_name + "_syn_out_opt_1_temp.txt > "+self.brief_name+"_opt_1_map.txt"
        ...
        return self._env.returns(), command_sequence, np.mean(sum_reward), gate_num, latency, energy, row_usage, energy_latency_product
